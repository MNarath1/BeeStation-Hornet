...
/datum/clockcult/scripture/slab/kindle/apply_effects(atom/A)
	...
	if(anti_magic_source)
		M.flash_lighting_fx(_color = LIGHT_COLOR_HOLY_MAGIC, _range = 2, _duration = 100)
	...
	if(iscultist(M))
		M.flash_lighting_fx(_color = LIGHT_COLOR_BLOOD_MAGIC, _range = 2, _duration = 300)
		M.stuttering += 15
		M.Jitter(15)
	...
	invoker.flash_lighting_fx(_color = LIGHT_COLOR_CLOCKWORK, _range = 2, _duration = 10)
